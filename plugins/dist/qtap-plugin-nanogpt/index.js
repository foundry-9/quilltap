...
var NanoGPTProvider = class extends OpenAICompatibleProvider {
  constructor(config2) {
    super({
      ...
      attachmentErrorMessage: config2?.attachmentErrorMessage ?? "NanoGPT chat requests are text-only in Quilltap. Send text-only messages."
    });
...
var NANOGPT_BASE_URL3 = "https://nano-gpt.com/api/v1";
var NanoGPTEmbeddingProvider = class {
  constructor(baseUrl) {
    this.baseUrl = baseUrl || NANOGPT_BASE_URL3;
  }
  /**
